...
public class CustomerCartServiceImpl implements CustomerCartService {
	...
	// of that customer
	@Override
	public Set<CartProductDTO> getProductsFromCart(String customerEmailId,
												   Integer pageNo,Integer pageSize) throws EKartCustomerCartException {
		...
		List<CartProduct> cp = customerCartRepository.getCartProductsByCartId(cart.getCartId(),paging);


	//	Set<CartProduct> cartProducts = cart.getCartProducts();
		for (CartProduct cartProduct : cp) {
